...
export default class LoadMoreButton extends AbstractView {
  constructor() {
    ...
    // 3. Теперь обработчик - метод класса, а не стрелочная функция.
  ...
  _clickHandler(evt) {
    evt.preventDefault();
    // 2. А внутри абстрактного обработчика вызовем колбэк
  ...
  setClickHandler(callback) {
    ...
    // 4. В addEventListener передадим абстрактный обработчик
